import { 
  ...
  const Contact = () => {
    ...
    const handlesubmit = async (e) => {
      ...
      try {
        const response = await fetch("https://portfolio-73jp.onrender.com/sendemail", {
            method: "POST",
          ...
          <HStack spacing={10} align="center" justify="center" flexWrap={{ base: "wrap", md: "nowrap" }}>
            ...
            <VStack spacing={2} w={{ base: "100%", md: "50%" }} marginTop={'30px'}>
              <HStack spacing={4}>
                ...
                <IconButton as="a" href="https://www.instagram.com/" target="_blank" rel="noopener noreferrer" color="pink.500" bg="white" borderRadius="full" boxSize="50px" border="2px solid" borderColor="pink.500" _hover={{ transform: "scale(1.2)", bg: "pink.100" }} transition="0.2s ease-in-out">
                  <FaInstagram size="70%" />
                </IconButton>
